...
def contains_quantity(order: str, quantity: int = 1, key: str = None, aws_csv_file: StringIO = None, database_csv_file: StringIO = None) -> bool:
    """
    ...
    return True if result[0][2] >= quantity else False
