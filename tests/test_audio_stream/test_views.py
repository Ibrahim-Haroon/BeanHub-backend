...
class AudioStreamTestCase(TestCase):
    ...
    def test_consume_messages_puts_received_messages_into_queue(
            self, mock_connection, mock_connection_params
    ) -> None:
        # Arrange
        unique_id = "test-id"
        ...
        # Act
        AudioStreamView.consume_messages(unique_id, message_queue)
        ...
        mock_connection.assert_called_once_with(mock_connection_params(host=ANY))
